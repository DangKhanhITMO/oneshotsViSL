...
np.save( '/home/khanhlinux/ML/autodata_sign (copy)/Data/0512/datanumpy/X_train_ok.npy', X_train)
np.save('/home/khanhlinux/ML/autodata_sign (copy)/Data/0512/datanumpy/y_train_ok.npy', y_train)
np.save( '/home/khanhlinux/ML/autodata_sign (copy)/Data/0512/datanumpy/X_test_ok.npy', X_test)
np.save('/home/khanhlinux/ML/autodata_sign (copy)/Data/0512/datanumpy/y_test_ok.npy', y_test)
print(X_train.shape)
print(y_train.shape)
model = Sequential()
